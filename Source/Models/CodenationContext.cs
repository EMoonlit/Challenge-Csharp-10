    ...
    public class CodenationContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
                //optionsBuilder.UseSqlServer(@"Server=DESKTOP-9HVV5PG\SQLEXPRESS;Initial Catalog=Codenation;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
                ...
                // optionsBuilder.UseSqlServer(@"Server=(localdb)\MSSQLLocalDB; Initial Catalog =Codenation; Integrated Security = True; Connect Timeout = 30; Encrypt = False; TrustServerCertificate = False; ApplicationIntent = ReadWrite; MultiSubnetFailover = False");
               // optionsBuilder.UseSqlServer(@"Server=(localdb)\mssqllocaldb;Database=Codenation;");
                optionsBuilder.UseSqlServer(@"Server=(localdb)\mssqllocaldb;Database=Codenation;Trusted_Connection=True");
            //optionsBuilder.UseSqlServer(@"Server=DESKTOP-9HVV5PG\SQLEXPRESS;Database=Codenation;Integrated Security=True;Connect;");
